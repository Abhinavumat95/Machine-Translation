...
def simple_model(input_shape, output_sequence_length, english_vocab_size, french_vocab_size):
    ...
    learning_rate = 1e-3
    model = Sequential()
    model.add(GRU(16, input_shape=input_shape[1:], return_sequences=True))
...
def embed_model(input_shape, output_sequence_length, english_vocab_size, french_vocab_size):
    ...
    learning_rate = 1e-3
    model = Sequential()
    model.add(Embedding(english_vocab_size, 16, input_length=input_shape[1], input_shape=input_shape[1:]))
...
def bd_model(input_shape, output_sequence_length, english_vocab_size, french_vocab_size):
    ...
    learning_rate = 1e-3
    model = Sequential()
    model.add(Bidirectional(GRU(16, return_sequences=True), input_shape=input_shape[1:]))
    model.add(Dense(32, activation='relu'))
    model.add(Dense(32, activation='relu'))
    model.add(Dense(french_vocab_size, activation='softmax'))
